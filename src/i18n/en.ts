...
export const en: Translations = {
  ...
  resources: {
    ...
    checking: 'Checking base models, voice models, and the inference engine.',
    desc: 'Real RVC needs base models and at least one voice model. Missing resources can be imported later.',
    sidecarError: 'Inference engine is not ready: {{message}}',
    hubert: 'HuBERT / ContentVec',
    rmvpe: 'RMVPE',
    voices: 'Voice models {{count}} / {{total}}',
    inference: 'Inference engine',
    inferenceCpu: 'Inference engine ready: CPU',
    inferenceGpu: 'Inference engine ready: {{name}}',
    recheck: 'Recheck',
